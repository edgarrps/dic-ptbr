export default function TitleBar() {
    return (
        <div className='flex items-center bg-stone-100 space-x-2 rounded-t-xl h-[30px]
        ...
        '>
            ...
            <h2 className='desktop:px-[223px] laptop:px-[170px] tablet:px-[130px] mobile:px-[25px] font-mono font-bold text-sm text-stone-500'>Dicionário pt-BR</h2>
        </div>
    )
}