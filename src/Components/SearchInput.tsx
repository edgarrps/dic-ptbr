...
export default function SearchInput() {
    ...
    return (
        <form onSubmit={handleSubmit} className='grid rounded-xl bg-cyan-400 w-[700px] h-[300px] place-items-center shadow-md hover:shadow-2xl ease-in-out duration-300'>
